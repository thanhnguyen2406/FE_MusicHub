    ...
    <div className="h-screen flex items-center justify-center bg-[#181818]">
      ...
      <div className="basis-[40%] flex flex-col items-center justify-center h-full pl-10">
        ...
        <div className="flex flex-row w-72 gap-4">
          ...
          <button className="bg-white hover:bg-gray-200 text-black font-semibold px-8 py-3 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 w-1/2">
            Sign up
          </button>
        </div>
      </div>
